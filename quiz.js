...
const questions = [
    ...
    { question: 'Who wrote "To Kill a Mockingbird"?', options: ['A) Mark Twain', 'B) Harper Lee', 'C) J.K. Rowling', 'D) Ernest Hemingway', 'E) F. Scott Fitzgerald'], answer: 'B' },
    ...
    { question: 'Which country is famous for its tulips?', options: ['A) Belgium', 'B) France', 'C) Netherlands', 'D) Germany', 'E) Switzerland'], answer: 'C' },
