...
const questions = [
  ...
  },
  {
    ...
    options: ["A) Venus", "B) Earth", "C) Mars", "D) Jupiter", "E) Saturn"],
    answer: "C",
  },
  {
...

  {
    ...
    options: [
      ...
      "D) Hypertext Multilayer Language",
      "E) Hypertext Multiple Language",
    ],
    answer: "A",
  },
  {
  ...
  {
    question: "In Python, what is used to indicate a block of code?",
    options: [
      "A) Curly braces {}",
      "B) Parentheses ()",
      "C) Indentation",
  ...
  },
  {
    ...
    options: ["A) INSERT", "B) DELETE", "C) SELECT", "D) UPDATE", "E) ALTER"],
    answer: "C",
  },

  {
    question: "What is the value of π (pi) to two decimal places?",
    options: ["A) 2.14", "B) 3.14", "C) 4.14", "D) 5.14", "E) 6.14"],
    answer: "B",
  },
  {
    question: "Solve: 8 × 7 - 5 + 3 = ?",
    options: ["A) 47", "B) 48", "C) 49", "D) 50", "E) 51"],
    answer: "A",
  },
  {
  ...
  },
  {
    ...
    options: ["A) 15", "B) 25", "C) 50", "D) 125", "E) 150"],
    answer: "D",
  },
  {
    question:
...
function askQuestion() {
  ...
  rl.question("Your answer (A-E): ", (userAnswer) => {
    clearInterval(interval);
